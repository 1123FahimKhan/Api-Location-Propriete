...
def reset():
    ...
    if not connection:
        print("Échec de la connexion à la base de données pour la réinitialisation.")
        return
    ...
    try:
        ...
        # Commandes de réinitialisation et de sélection de la BD (avec point-virgule corrigé)
        cursor.execute("DROP DATABASE IF EXISTS fkhan_locations;")
        cursor.execute("CREATE DATABASE IF NOT EXISTS fkhan_locations;")
        cursor.execute("USE fkhan_locations;") 
        ...
        # Insertion des données (Mat est maintenant 'proprietaire')
        cursor.execute("""
        ...
        # Insertion des propriétaires (Mat ajouté)
        cursor.execute("""
        ...
        connection.commit()
        print("Réinitialisation de la base de données effectuée avec succès.")

    except Exception as e:
        print(f"Une erreur interceptée dans la réinitialisation de la base de donnée : {e}")
